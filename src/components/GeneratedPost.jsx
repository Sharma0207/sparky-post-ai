...
export const GeneratedPost = ({ caption, hashtags, imageUrl, isSelected, onSelect, onPostToFacebook }) => {
    ...
    >
      ...
      <div className="p-4 space-y-3 bg-card">
        ...
        <div className="flex flex-wrap gap-1">
          ...
          {hashtags.length > 4 && (
            <span className="text-xs text-muted-foreground px-2 py-1">+{hashtags.length - 4} more</span>
          )}
        </div>
