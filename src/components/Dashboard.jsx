...
export const Dashboard = () => {
  ...
  const handlePromptSubmit = async () => {
    ...
    if (!supabaseUrl) {
      toast({
        ...
        description: "VITE_SUPABASE_URL is not set. Configure Supabase to enable post generation.",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleShareViaFacebook = () => {
    ...
    // Prefer Facebook Share Dialog when SDK is available; fallback to sharer.php
    if (appId && window.FB) {
      window.FB.ui(
        {
          method: "share",
